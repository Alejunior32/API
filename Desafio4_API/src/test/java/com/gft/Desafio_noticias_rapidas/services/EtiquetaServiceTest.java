...
import com.gft.Desafio_noticias_rapidas.repositories.EtiquetaRepository;
...
public class EtiquetaServiceTest {
    ...
    private void startEtiqueta(){
        etiqueta = new Etiqueta(ID, NOME_ETIQUETA);
        op_etiqueta = Optional.of(new Etiqueta(ID, NOME_ETIQUETA));
